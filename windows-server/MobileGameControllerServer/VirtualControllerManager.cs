...
public class VirtualControllerManager : IDisposable
{
    ...
    {
        // Convert -1..1 float to Xbox short range (-32768..32767)
    ...
    /// <summary>
    /// LT/RT are sent as button press; map to trigger axes (0-255).
    /// </summary>
    ...
    private static Xbox360Button? MapButton(string button) => button.ToUpperInvariant() switch
    {
        ...
        "LT" => null, // Handled via trigger axis
        "RT" => null,
        _ => null
    };
    ...
    public void Dispose()
    {
        ...
        _client.Dispose();
        Console.WriteLine("[ViGEm] Virtual controller disconnected.");
    }
}
